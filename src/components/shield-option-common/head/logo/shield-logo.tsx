...
import darkLogo from '../../../../assets/imgs/logo/doption.svg';
import lightLogo from '../../../../assets/imgs/logo/doption.svg';
import mobileLogo from '../../../../assets/imgs/logo/doption.svg';
  ...
  render() {
    ...
    return (
      <div className={styleMr(styles.wrapperLogo)}>
        <img src={logoUrl} alt={''} height={this.state.isMobile ? 28 : 32} />
      </div>
    );
  }
}
